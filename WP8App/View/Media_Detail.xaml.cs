...
{
    /// <summary>
    /// Phone application page for Media_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Media_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Media_Detail and all its components.
        /// </summary>
        public Media_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaMedia_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaMedia_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaMedia_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaMedia_Detail(PanoramaMedia_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaMedia_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IMedia_MediaRSS>();
				AddHomeAppBarButton();
				...
				((IViewModels.IMedia_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
