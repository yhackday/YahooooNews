...
{
    /// <summary>
    /// Phone application page for Health_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Health_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Health_Detail and all its components.
        /// </summary>
        public Health_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaHealth_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaHealth_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaHealth_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaHealth_Detail(PanoramaHealth_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaHealth_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IHealth_HealthRSS>();
				AddHomeAppBarButton();
				...
				((IViewModels.IHealth_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
