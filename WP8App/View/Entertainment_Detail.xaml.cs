...
{
    /// <summary>
    /// Phone application page for Entertainment_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Entertainment_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Entertainment_Detail and all its components.
        /// </summary>
        public Entertainment_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaEntertainment_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaEntertainment_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaEntertainment_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaEntertainment_Detail(PanoramaEntertainment_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaEntertainment_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IEntertainment_EntertainmentRSS>();
				AddHomeAppBarButton();
				...
				((IViewModels.IEntertainment_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
