...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.IAllNews_NewsViewModel), "/View/AllNews_News.xaml" },
            { typeof(IViewModels.IMedia_DetailViewModel), "/View/Media_Detail.xaml" },
            { typeof(IViewModels.IHealth_DetailViewModel), "/View/Health_Detail.xaml" },
            { typeof(IViewModels.IEntertainment_DetailViewModel), "/View/Entertainment_Detail.xaml" },
            { typeof(IViewModels.ICelebrities_EntertainmentViewModel), "/View/Celebrities_Entertainment.xaml" },
            { typeof(IViewModels.IBusiness_DetailViewModel), "/View/Business_Detail.xaml" },
            { typeof(IViewModels.IAllNews_DetailViewModel), "/View/AllNews_Detail.xaml" },
