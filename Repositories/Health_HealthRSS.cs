...
namespace WPAppStudio.Repositories
{
    ...
    public class Health_HealthRSS : IHealth_HealthRSS 
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Health_HealthRSS" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
        public Health_HealthRSS(RepositoriesBase.IXmlDataSource xmlDataSource)
        {
