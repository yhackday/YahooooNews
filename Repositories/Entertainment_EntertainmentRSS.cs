...
namespace WPAppStudio.Repositories
{
    ...
    public class Entertainment_EntertainmentRSS : IEntertainment_EntertainmentRSS 
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Entertainment_EntertainmentRSS" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
        public Entertainment_EntertainmentRSS(RepositoriesBase.IXmlDataSource xmlDataSource)
        {
